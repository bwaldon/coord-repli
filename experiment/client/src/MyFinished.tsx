  ...
  return (
    <div className="h-full flex flex-col items-center justify-center">
      { player.get("ended") == "game ended" 
        ? <><h2 className="font-medium text-gray-700">Finished!</h2><p className="mt-2 text-gray-400">Thank you for participating.</p> <h2 className="font-medium text-gray-700">Your completion code: C1C7NS9D</h2></>
